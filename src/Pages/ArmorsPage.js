...
<Link to="add" className='px-3 py-2 text-white bg-green-600 rounded-lg font-semibold'> Add Armor</Link>
          ...
          {armors.map((data, index) => (
            <tr key={index} className="bg-white border-b">
              ...
              <td className=" flex space-x-4  whitespace-nowrap justify-center items-center mt-1">
                ...
                <Link to={`/armors/add`} className='px-6 py-2 text-white bg-blue-600 rounded-lg font-semibold bg-green-600 rounded-lg font-semibold bg-green-500 hover:bg-green-600 active:bg-green-700 focus:outline-none focus:ring focus:ring-green-300'> Add Items</Link>
              </td>
            </tr>
            ))}
